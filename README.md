...
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,145 | 🐛 50 | 🌐 TypeScript | 📅 2026-05-05 - The complete solution for building interactive command-line tools.
...
* [deno\_mongo](https://github.com/denodrivers/mongo) ⭐ 514 | 🐛 48 | 🌐 TypeScript | 📅 2025-03-14 - MongoDB database driver.
...
* [maxminddb](https://github.com/josh-hemphill/maxminddb-wasm) ⭐ 17 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-03 - A library that enables the usage of MaxmindDB geoIP database files
...
* [fresh](https://github.com/denoland/fresh) ⭐ 13,750 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-28 - The next-gen web framework.
* [ultra](https://github.com/exhibitionist-digital/ultra) ⭐ 2,955 | 🐛 28 | 🌐 TypeScript | 📅 2024-10-28 - 💎 Modern Streaming React Framework in Deno.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,771 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-05 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [LiteMarkup](https://github.com/tuures/LiteMarkup) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-04 - AST-first parser. Under 3 KB gzipped, zero dependencies.
...
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 935 | 🐛 86 | 🌐 TypeScript | 📅 2026-05-07 - Discord API library for Deno
...
* [eta](https://github.com/bgub/eta) ⭐ 1,712 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-25 - Fast, lightweight, and configurable embedded template engine.
...
* [superdeno](https://github.com/cmorten/superdeno) ⭐ 122 | 🐛 1 | 🌐 TypeScript | 📅 2025-05-18 - Super-agent driven library for testing Deno HTTP servers.
* [superoak](https://github.com/cmorten/superoak) ⭐ 119 | 🐛 1 | 🌐 TypeScript | 📅 2025-11-15 - HTTP assertions for Oak made easy via SuperDeno.
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 283 | 🐛 41 | 🌐 JavaScript | 📅 2026-05-07 - 🏞 \[a]synchronous function composition; it just works.
...
* [wu-diff-js](https://github.com/bokuweb/wu-diff-js) ⭐ 19 | 🐛 13 | 🌐 TypeScript | 📅 2026-04-29 - A diff library to compute differences between two slices using wu(the O(NP)) algorithm.
...
* [zod](https://github.com/colinhacks/zod) ⭐ 42,614 | 🐛 107 | 🌐 TypeScript | 📅 2026-05-07 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 30,342 | 🐛 356 | 🌐 TypeScript | 📅 2026-05-06 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
* [oak](https://github.com/oakserver/oak) ⭐ 5,405 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-22 - A middleware framework for Deno's net server.
...
* [drash](https://github.com/drashland/drash) ⭐ 1,067 | 🐛 15 | 🌐 TypeScript | 📅 2024-10-08 - A REST microframework for Deno's HTTP server with zero dependencies.
...
* [webview](https://github.com/webview/webview_deno) ⭐ 1,596 | 🐛 42 | 🌐 TypeScript | 📅 2025-02-25 - Deno bindings for webview, a tiny library for creating web-based desktop GUIs.
...
* dvm
  * [justjavac/dvm](https://github.com/justjavac/dvm) ⭐ 705 | 🐛 12 | 🌐 Rust | 📅 2026-05-07 - Deno Version Manager: manage multiple active Deno versions.
  * [axetroy/dvm](https://github.com/axetroy/dvm) ⭐ 165 | 🐛 14 | 🌐 Go | 📅 2024-08-27 - Version manger for Deno without runtime dependencies.
  * [asdf-community/asdf-deno](https://github.com/asdf-community/asdf-deno) ⭐ 134 | 🐛 7 | 🌐 Shell | 📅 2026-04-07 - Deno plugin for [asdf](https://asdf-vm.com/)
