...
* [yargs](https://github.com/yargs/yargs) ⭐ 11,490 | 🐛 317 | 🌐 JavaScript | 📅 2026-05-10 - The modern, pirate-themed successor to optimist.
* [cac](https://github.com/cacjs/cac) ⭐ 3,084 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-22 - Simple yet powerful framework for building command-line apps.
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,155 | 🐛 46 | 🌐 TypeScript | 📅 2026-05-30 - The complete solution for building interactive command-line tools.
...
* [clite](https://github.com/jersou/clite-parser) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-30 - Automatic CLI generation from a class.
...
* [denodb](https://github.com/eveningkid/denodb) ⭐ 1,927 | 🐛 105 | 🌐 TypeScript | 📅 2023-10-28 - MySQL, SQLite, MariaDB, PostgreSQL and MongoDB ORM for Deno.
...
* [fresh](https://github.com/denoland/fresh) ⭐ 13,758 | 🐛 85 | 🌐 TypeScript | 📅 2026-05-27 - The next-gen web framework.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,819 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-25 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,609 | 🐛 14 | 🌐 TypeScript | 📅 2026-05-16 - Telegram Bot API framework for Deno.
...
* [zod](https://github.com/colinhacks/zod) ⭐ 42,827 | 🐛 165 | 🌐 TypeScript | 📅 2026-05-19 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 30,698 | 🐛 358 | 🌐 TypeScript | 📅 2026-05-28 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [drash](https://github.com/drashland/drash) ⭐ 1,068 | 🐛 15 | 🌐 TypeScript | 📅 2026-05-30 - A REST microframework for Deno's HTTP server with zero dependencies.
...
* [GitHub Profile Trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,545 | 🐛 25 | 🌐 TypeScript | 📅 2026-05-30 - 🏆 Add dynamically generated GitHub Trophy on your readme
...
* [vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,549 | 🐛 120 | 🌐 TypeScript | 📅 2026-05-18 - VS Code extension that provides Deno support using the `TypeScript Deno language service plugin`.
