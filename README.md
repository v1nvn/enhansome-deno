...
* [yargs](https://github.com/yargs/yargs) ⭐ 11,485 | 🐛 316 | 🌐 JavaScript | 📅 2026-05-10 - The modern, pirate-themed successor to optimist.
* [cac](https://github.com/cacjs/cac) ⭐ 3,069 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-05 - Simple yet powerful framework for building command-line apps.
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,149 | 🐛 50 | 🌐 TypeScript | 📅 2026-05-05 - The complete solution for building interactive command-line tools.
...
* [fresh](https://github.com/denoland/fresh) ⭐ 13,763 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-15 - The next-gen web framework.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,792 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-17 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [lume](https://github.com/lumeland/lume) ⭐ 2,257 | 🐛 40 | 🌐 TypeScript | 📅 2026-05-17 - A static site generator similar to Jekyll or Eleventy with support for multiple file formats.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,582 | 🐛 13 | 🌐 TypeScript | 📅 2026-05-16 - Telegram Bot API framework for Deno.
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 937 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-11 - Discord API library for Deno
* [MTKruto](https://github.com/MTKruto/MTKruto) ⭐ 161 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-17 - Deno-first, cross-runtime client library for Telegram's MTProto API.

### Template engine

* [eta](https://github.com/bgub/eta) ⭐ 1,716 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-25 - Fast, lightweight, and configurable embedded template engine.
...
* [croner](https://github.com/Hexagon/croner) ⭐ 2,556 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-17 - Cron library with advanced scheduling features, well-documented API, and zero dependencies.
...
* [switcher4deno](https://github.com/switcherapi/switcher-client-deno) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-17 - Feature Flag Deno SDK client for Switcher-API.
* [dinoenv](https://deno.land/x/dinoenv) - tiny library to manage environment variables with deno.

### Validation

* [zod](https://github.com/colinhacks/zod) ⭐ 42,697 | 🐛 130 | 🌐 TypeScript | 📅 2026-05-16 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 30,506 | 🐛 364 | 🌐 TypeScript | 📅 2026-05-17 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [webview](https://github.com/webview/webview_deno) ⭐ 1,593 | 🐛 42 | 🌐 TypeScript | 📅 2025-02-25 - Deno bindings for webview, a tiny library for creating web-based desktop GUIs.
...
* [GitHub Profile Trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,532 | 🐛 23 | 🌐 TypeScript | 📅 2026-04-13 - 🏆 Add dynamically generated GitHub Trophy on your readme
...
* [deno\_docker](https://github.com/denoland/deno_docker) ⭐ 1,013 | 🐛 14 | 🌐 Dockerfile | 📅 2026-04-28 - Latest dockerfiles and images for Deno - alpine, centos, debian, ubuntu.
...
* [studio-pack-generator](https://github.com/jersou/studio-pack-generator) ⭐ 119 | 🐛 2 | 🌐 TypeScript | 📅 2025-01-04 - Convert a folder or a RSS URL to Studio pack for Lunii device
