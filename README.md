...
* [yargs](https://github.com/yargs/yargs) ⭐ 11,484 | 🐛 318 | 🌐 JavaScript | 📅 2026-05-10 - The modern, pirate-themed successor to optimist.
* [cac](https://github.com/cacjs/cac) ⭐ 3,072 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-22 - Simple yet powerful framework for building command-line apps.
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,150 | 🐛 51 | 🌐 TypeScript | 📅 2026-05-05 - The complete solution for building interactive command-line tools.
...
* [denodb](https://github.com/eveningkid/denodb) ⭐ 1,928 | 🐛 105 | 🌐 TypeScript | 📅 2023-10-28 - MySQL, SQLite, MariaDB, PostgreSQL and MongoDB ORM for Deno.
* [postgres](https://github.com/denodrivers/postgres) ⭐ 653 | 🐛 38 | 🌐 TypeScript | 📅 2025-04-24 - Driver for PostgreSQL database.
...
* [Denops](https://github.com/vim-denops/denops.vim) ⭐ 788 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-15 - 🐜 An ecosystem to write Vim/Neovim plugins with Deno.

### Frontend framework

* [fresh](https://github.com/denoland/fresh) ⭐ 13,765 | 🐛 86 | 🌐 TypeScript | 📅 2026-05-15 - The next-gen web framework.
...
* [caviar](https://github.com/load1n9/caviar) ⭐ 170 | 🐛 4 | 🌐 TypeScript | 📅 2025-09-03 - ⚡ Blazing fast, modern, Game Engine powered by WebGPU for Deno and the browser
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,807 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-20 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,597 | 🐛 14 | 🌐 TypeScript | 📅 2026-05-16 - Telegram Bot API framework for Deno.
...
* [switcher4deno](https://github.com/switcherapi/switcher-client-deno) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-23 - Feature Flag Deno SDK client for Switcher-API.
* [dinoenv](https://deno.land/x/dinoenv) - tiny library to manage environment variables with deno.

### Validation

* [zod](https://github.com/colinhacks/zod) ⭐ 42,752 | 🐛 144 | 🌐 TypeScript | 📅 2026-05-19 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 30,571 | 🐛 357 | 🌐 TypeScript | 📅 2026-05-22 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [GitHub Profile Trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,540 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-13 - 🏆 Add dynamically generated GitHub Trophy on your readme
...
* [deno\_docker](https://github.com/denoland/deno_docker) ⭐ 1,014 | 🐛 16 | 🌐 Dockerfile | 📅 2026-05-22 - Latest dockerfiles and images for Deno - alpine, centos, debian, ubuntu.
