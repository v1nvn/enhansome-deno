...
* [yargs](https://github.com/yargs/yargs) ⭐ 11,489 | 🐛 321 | 🌐 JavaScript | 📅 2026-05-10 - The modern, pirate-themed successor to optimist.
* [cac](https://github.com/cacjs/cac) ⭐ 3,088 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-22 - Simple yet powerful framework for building command-line apps.
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,157 | 🐛 43 | 🌐 TypeScript | 📅 2026-06-04 - The complete solution for building interactive command-line tools.
...
* [clite](https://github.com/jersou/clite-parser) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-04 - Automatic CLI generation from a class.
...
* [fresh](https://github.com/denoland/fresh) ⭐ 13,754 | 🐛 87 | 🌐 TypeScript | 📅 2026-06-03 - The next-gen web framework.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,818 | 🐛 12 | 🌐 TypeScript | 📅 2026-05-25 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [lume](https://github.com/lumeland/lume) ⭐ 2,260 | 🐛 41 | 🌐 TypeScript | 📅 2026-05-29 - A static site generator similar to Jekyll or Eleventy with support for multiple file formats.
...
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 937 | 🐛 91 | 🌐 TypeScript | 📅 2026-06-02 - Discord API library for Deno
...
* [eta](https://github.com/bgub/eta) ⭐ 1,726 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-25 - Fast, lightweight, and configurable embedded template engine.
...
* [croner](https://github.com/Hexagon/croner) ⭐ 2,558 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-05 - Cron library with advanced scheduling features, well-documented API, and zero dependencies.
...
* [zod](https://github.com/colinhacks/zod) ⭐ 42,863 | 🐛 180 | 🌐 TypeScript | 📅 2026-06-04 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 30,816 | 🐛 366 | 🌐 TypeScript | 📅 2026-06-03 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,546 | 🐛 120 | 🌐 TypeScript | 📅 2026-05-18 - VS Code extension that provides Deno support using the `TypeScript Deno language service plugin`.
...
* dvm
  ...
  * [asdf-community/asdf-deno](https://github.com/asdf-community/asdf-deno) ⭐ 133 | 🐛 8 | 🌐 Shell | 📅 2026-06-02 - Deno plugin for [asdf](https://asdf-vm.com/)
